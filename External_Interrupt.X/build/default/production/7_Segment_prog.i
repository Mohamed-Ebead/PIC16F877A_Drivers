...
typedef float f32;
typedef double f64;
# 13 "7_Segment_prog.c" 2



# 1 "./_7_segment_private.h" 1
# 15 "./_7_segment_private.h"
const u8 u8_Left_7Segment [10] = {0x3F,0x06,0x5B,0x4F,0x66,0x6D,0x7D,0x07,0x7F,0x6F} ;
const u8 u8_Right_7Segment [10] = {0x3F,0x06,0x5B,0x4F,0x66,0x6D,0x7D,0x07,0x7F,0x6F} ;
# 16 "7_Segment_prog.c" 2
...
void vid_7_Segment_Init (void)
{
    ...
    DIO_SetPortDirection(3 , 0x00) ;


    DIO_SetPinValue(0 , 2 , 0) ;
    DIO_SetPinValue(0 , 3 , 0) ;

    DIO_SetPortValue(0 , 0x00) ;
...
{
    DIO_SetPinValue(0 , 3 , 0) ;
    DIO_SetPinValue(0 , 2 , 1) ;

    DIO_SetPortValue(3,u8_Left_7Segment[u8_Number]) ;
...
{
    DIO_SetPinValue(0 , 2 , 0) ;
    DIO_SetPinValue(0 , 3 , 1) ;
    DIO_SetPortValue(3,u8_Right_7Segment[u8_Number]) ;
