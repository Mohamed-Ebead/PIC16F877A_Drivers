...
void vid_SystemInit (void)
{
     DIO_SetPinDirection (1, 1, 1);
 DIO_SetPinDirection (1, 2, 1);
 DIO_SetPinDirection (1, 3, 1);
...
void RedLed_TOG (void)
{
    ((*((volatile u8*)0x06))) ^= (1 << (1)) ;
}
void GreenLed_TOG (void)
{
    ((*((volatile u8*)0x06))) ^= (1 << (2)) ;
}
void YellowLed_TOG (void)
{
    ((*((volatile u8*)0x06))) ^= (1 << (3)) ;
}
